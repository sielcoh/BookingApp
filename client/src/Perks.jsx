        ...
        <div>
            ...
            <div className='grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mt-2'>
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='wifi' className='cursor-pointer' onChange={handleCbClick} />
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='parking' className='cursor-pointer' onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='tv' className='cursor-pointer' onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='pets' className='cursor-pointer' onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='entrance' className='cursor-pointer' onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                    <input type="checkbox" name='radio' className='cursor-pointer' onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
